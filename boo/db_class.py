...
class Follow(Base):	
    ...
    fk_user = relationship('User', foreign_keys=[userno])
    fk_following = relationship('User', foreign_keys=[following])

    # __table_args__ = (PrimaryKeyConstraint('userno', 'following'), {})
